...
def myNetwork():
    ...
    TCLink(r1, h1, IntfName1="r1-eth0", bw=50, delay="15ms", jitter="1ms", loss=0, enable_red=True, max_queue_size=100)
    TCLink(r1, h2, IntfName1="r1-eth1", bw=10, delay="5ms", jitter="1ms", loss=0, enable_red=True, max_queue_size=100)
    TCLink(r1, h3, IntfName1="r1-eth2", bw=50, delay="5ms", jitter="1ms", loss=0, enable_red=True, max_queue_size=100)
