...
def myNetwork():
    ...
    r1.cmd('ifconfig r1-eth1 10.0.1.4 netmask 255.255.255.0 mtu 500')
    server.cmd('ifconfig server-eth0 10.0.1.1 netmask 255.255.255.0 mtu 500')

    info('*** Adding routes\n')
    h1.cmd('route add default gw 10.0.0.4')
    h2.cmd('route add default gw 10.0.0.4')
    h3.cmd('route add default gw 10.0.0.4')
    server.cmd('route add default gw 10.0.1.4')
