    ...
    def bwCmds( self, bw=None, speedup=0, use_hfsc=False, use_tbf=False,
        ...
        if bw and ( bw < 0 or bw > 1000 ):
            ...
            if use_hfsc:
                ...
                cmds += [ '%s qdisc add dev %s root handle 5:0 htb default 1 r2q 4000 direct_qlen 10',
            ...
            if enable_ecn:
                cmds += [ '%s qdisc add dev %s' + parent +
                          'handle 6: red limit 4250000 ' +
                          'min 4000000 max 4250000 avpkt 1500 ' +
                          'burst 0 ' +
                          'bandwidth %fmbit probability 1 ecn' % bw ]
                parent = ' parent 6: '
            elif enable_red:
                cmds += [ '%s qdisc add dev %s' + parent +
                          'handle 6: red limit 150000 ' +
                          'min 10000 max 100000 avpkt 1000 ' +
                          'burst 0 ' +
                          'bandwidth %fmbit probability 0.03' % bw ]
                parent = ' parent 6: '
        return cmds, parent
