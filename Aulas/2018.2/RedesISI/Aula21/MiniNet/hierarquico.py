...
def myNetwork():
    ...
    TCLink(fbn_r, h3, bw=10, delay="15ms", jitter="1ms", loss=0, max_queue_size=100)
    ...
    fbn_r.cmd('ifconfig FlyByNight-eth2 200.20.20.2 netmask 255.255.254.0 txqueuelen 1')
    fbn_r.cmd('ifconfig FlyByNight-eth3 10.0.0.2 netmask 255.255.255.0 txqueuelen 1')
    ru_r.cmd('ifconfig RsUs-eth0 10.0.1.2 netmask 255.255.255.0 txqueuelen 1')
