...
def myNetwork():
    ...
    TCLink(r1, h2, IntfName1="r1-eth1", bw=10, delay="5ms", jitter="1ms", loss=0, enable_red=True)
    TCLink(r1, h3, IntfName1="r1-eth2", bw=50, delay="5ms", jitter="1ms", loss=0, enable_red=True)
    TCLink(r1, h4, IntfName1="r1-eth3", bw=10, delay="5ms", jitter="1ms", loss=0, enable_red=True)
    ...
    r1.cmd('ifconfig r1-eth3 10.0.4.1 netmask 255.255.255.0')
    ...
    h4.cmd('ifconfig h4-eth0 10.0.4.2 netmask 255.255.255.0')
