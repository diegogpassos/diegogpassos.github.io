...
Dz.postInit = function() {

	var i;

    if (DzPostInitFunctions.length > 0) {

        document.onchange = function(){console.log('changed!!!');}
        Dz.goEnd();

        if (typeof DzPostInitFunctions !== 'undefined') {

            for (i = 0; i < DzPostInitFunctions.length; i++) {
            
                DzPostInitFunctions[i]();
            }
        }
        window.setTimeout(function(){Dz.goStart();}, 1000);
    }
}
